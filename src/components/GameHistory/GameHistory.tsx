...
export const GameHistory = ({
  ...
  const getResultIcon = (result: GameResult["result"]) => {
    switch (result) {
      case "player-wins":
  ...
  const getResultText = (result: GameResult["result"]) => {
    switch (result) {
      case "player-wins":
        return "Win";
      case "dealer-wins":
  ...
  const getResultColor = (result: GameResult["result"]) => {
    switch (result) {
      case "player-wins":
  ...
  const winRate = history.length > 0 ? (gamesWon / history.length) * 100 : 0;
